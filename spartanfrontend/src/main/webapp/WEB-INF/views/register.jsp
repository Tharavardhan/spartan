	...
	<div class="row">
		<div>
			...
			<form:form modelAttribute="ud" action="addUser" method="post">
				...
				<div class="form-group">
					<form:input type="text" id="E-mail Address" class="form-control"
						placeholder="E-mail Address" path="emailid" />
					<form:errors path="emailid" class="stylingerror" />
				</div>
				<div class="form-group">
					<form:input type="text" id="Mobile Number" class="form-control"
						placeholder="Mobile Number" path="phno" />
					<form:errors path="phno" class="stylingerror" />
				</div>
				<div class="form-group">
					<form:input type="text" id="userPassword" class="form-control"
						placeholder="password" path="user_Password" />
					<form:errors path="user_Password" class="stylingerror" />
				</div>
				<div class="form-group">
					<span class="group-btn"><input
						type="submit" class="btn btn-primary btn-md" value="Register">
					</span>
				</div>
			</form:form>
		</div>
